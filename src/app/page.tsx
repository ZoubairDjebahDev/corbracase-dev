        ...
        <MaxWithWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 left-0 -top-20 hidden lg:block">
                <img src="/images/snake-1.png" alt="snake" className="w-full" />
              </div>
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              <Phone imgSrc="/images/testimonials/1.jpg" className="w-64" />
            </div>
          </div>
        </MaxWithWrapper>
      </section>
        ...
        <MaxWithWrapper className="py-24">
          ...
          <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            ...
            <div className="flex justify-center">
              ...
              >
                Create your case now <ArrowRight className="h-4 w-4 ml-q.5" />{" "}
              </Link>
            </div>
          </ul>
        </MaxWithWrapper>
